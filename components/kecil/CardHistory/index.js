...
const CardHistory = ({pesanan}) => {
  return (
    <View style={styles.container}>
      <Text style={styles.tanggal}>{pesanan.tanggalPesan}</Text>
        ...
        return (
          ...
          <View key={index} style={styles.history}>
            ...
            <View style={styles.desc}>
                ...
                <Text style={styles.textBold}>Pesan : {history.jumlahPesanan}</Text>
                <Text style={styles.textBoldPrimary}>Catatan: {history.catatan}</Text>
      ...
      <View style={styles.footer}>
        ...
        <View style={styles.label}>
            ...
            <Text style={styles.textBlue}>Rp. {numberWithCommas(pesanan.totalHarga)}</Text>
        </View>
